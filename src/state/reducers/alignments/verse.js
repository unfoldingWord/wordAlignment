 ...
 */
export const compileLegacy = (rendered, alignments) => {
...
//       compileApprovedRender(renderPos, renders, siblingIndex, compiledRenders);
//     } else {
...
//         const alignment = alignments[aIndex];
//         const suggestedTaretTokens = _.difference(alignment.targetNgram,
//           r.targetNgram);
//         const isAlignmentUpdated = _.difference(suggestedTaretTokens,
//           r.suggestedTargetTokens).length > 0;
...
//               sourceNgram: [...r.sourceNgram],
//               targetNgram: [...suggestedTaretTokens]
//             }
//           };
...
//       if (sIndex !== rIndex) {
//         compileSplitSiblings(sIndex, renders, siblingIndex, compiledRenders);
//       }
//     }
//   }
// };
