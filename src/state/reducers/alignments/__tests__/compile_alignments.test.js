  ...
  describe('complex', () => {
    it('compiles an unalignment where there is an unaccepted split suggestion', () => { // example from Titus 2:1
      ...
      const rendered = [
        ...
        {"sourceNgram": [5], "targetNgram": [], "suggestedTargetTokens": [], "alignments": [4], "suggestion": 5},
      ...
      const expected = {
        ...
        "indices": {
          ...
          "6": [5]} // TODO: the current algorithm is putting a [6] here which is out of range and causes a later crash when you align the word back in
      };
