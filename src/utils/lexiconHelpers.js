...
import { getLatestVersion } from '../utils/resourcesHelpers';
...
export function getLexiconData(lexiconId, entryId) {
  try {
    ...
    const latestVersionPath = getLatestVersion(path.join(USER_RESOURCES_PATH, languageId, 'lexicons', lexiconId));
